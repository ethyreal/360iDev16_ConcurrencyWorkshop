...
class TiltShiftOperation: Operation {
  ...
  override func main() {
    ...
    if let dependencyImageProvider = dependencies.filter({ $0 is FilterDataProvider }).first as? FilterDataProvider, inputImage == .none {
     
        self.inputImage = dependencyImageProvider.outputImage
    }
